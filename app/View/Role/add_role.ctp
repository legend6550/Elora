<div class="breadcrumbs" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li>
			<a href="#">Quản lý nhóm tài khoản</a>
		</li>
		<li class="active">Thêm nhóm tài khoản</li>
	</ul>
</div>
		...
		<div class="col-sm-4">
			<div class="widget-box transparent">
				...
				<div class="widget-body">
					...
					<?php
						echo $this->Form->create('authoritie', array('Controller' => 'Role','Action'=>'addRole','id'=>'frminfomation','method'=>'post','class'=>'form-horizontal'));
						...
						echo $this->Form->checkbox('DefaultRegister', array('class'=>'ace'));
						echo '<span class="lbl">Nhóm tài khoản mật định khi đăng ký</span></label></div><hr>';
						echo '<div><button type="submit" class="btn btn-sm btn-primary" name="btnsave"><i class="ace-icon fa fa-floppy-o icon-on-right bigger-110"></i>Lưu</button><a href="/dashboard/role" class="btn btn-sm btn-danger" style="margin-left: 5px;"><i class="ace-icon fa fa-times icon-on-right bigger-110"></i>Hủy</a></div>';
					?>
				</div>
			</div>
		</div>
